...
| 12 | [物料体系](./12-element-system.md) | 物料类型定义、PropSchema、交互策略、内置物料（text/image/table/barcode 等） |
...
| 23 | [关键设计决策记录](./23-design-decisions.md) | 120+ 项 ADR |
...
- **想开发自定义物料?** -> [12-element-system](./12-element-system.md) + [03-monorepo-structure](./03-monorepo-structure.md)（物料包结构与导出规范）
