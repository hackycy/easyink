...
| --- | --- | --- |
| [@easyink/designer](packages/designer) | [![npm][designer-npm-version-src]][designer-npm-version-href] | [![npm downloads][designer-npm-downloads-src]][designer-npm-version-href] |
| [@easyink/viewer](packages/viewer) | [![npm][viewer-npm-version-src]][viewer-npm-version-href] | [![npm downloads][viewer-npm-downloads-src]][viewer-npm-version-href] |
| [@easyink/mcp-server](packages/mcp-server) | [![npm][mcp-server-npm-version-src]][mcp-server-npm-version-href] | [![npm downloads][mcp-server-npm-downloads-src]][mcp-server-npm-version-href] |
