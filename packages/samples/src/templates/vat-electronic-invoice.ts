...
function textNode(id: string, x: number, y: number, width: number, height: number, content: string, options: TextOptions = {}): MaterialNode {
  return {
    id,
    type: 'text',
    modelVersion: 1,
...
function rectNode(id: string, x: number, y: number, width: number, height: number, borderColor: string, borderWidth = 0.25): MaterialNode {
  return {
    id,
    type: 'rect',
    modelVersion: 1,
...
function ruleNode(id: string, x: number, y: number, width: number, height: number, color = TAX_RED): MaterialNode {
  return {
    id,
    type: 'rect',
    modelVersion: 1,
