...
- `packages/builtin/src/designer.ts`, `packages/builtin/src/viewer.ts`, `packages/builtin/src/all.ts`, `packages/builtin/src/basic.ts`, `packages/builtin/src/none.ts`, and `packages/builtin/src/bindings.ts` for built-in registration and package-size entry points.
