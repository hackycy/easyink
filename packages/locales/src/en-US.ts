...
const enUS: LocaleMessages = {
  designer: {
    ...
    condition: {
      ...
      enabled: 'Enable conditions',
      enabledHint: 'Viewer uses these conditions to show or hide the element',
      disabledHint: 'Configuration is preserved but not evaluated',
      ...
      logicHint: 'All conditions in a group must match. The overall condition matches when any group matches.',
      or: 'OR',
      group: 'Condition group',
      groupAndHint: 'All conditions below must match',
      selectCollection: 'Select collection field',
      collectionInfix: 'with',
      collectionMatchSuffix: 'matching',
      collectionTag: 'Collection',
      quantifierAny: 'At least one',
      quantifierAll: 'Every',
      quantifierNone: 'No',
